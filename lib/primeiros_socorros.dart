...
class _PrimeirosSocorrosState extends State<PrimeirosSocorros> {
  ...
  List<Widget> _conteudoPassoAPasso() {
    return [
      ...
      itemTexto("Resfrie:"),
      itemTexto("Coloque a queimadura debaixo de água corrente e fresca por pelo menos 10 a 20 minutos. Nunca use gelo, pois ele pode causar mais danos ao tecido."),
  ...
  List<Widget> _conteudoEmergencia() {
    return [
      ...
      const SizedBox(height: 15),
      itemTexto("• A queimadura for extensa ou profunda (atingir camadas mais profundas da pele, ficando esbranquiçada ou carbonizada)."),
      itemImagem('assets/nao_faca_isso.png', largura: 110),
      const Divider(),
      itemTexto("• Atingir o rosto, mãos, pés, articulações ou partes íntimas."),
